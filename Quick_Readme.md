...
- **Time Domain (s) / Freq. Domain (Hz) / Clear (solo en Oscilador 1):** Definen la duración de la secuencia (segundos) y el rango de frecuencias (Hz mínimo y máximo) de los ejes de las gráficas, y **Clear** limpia los trazados. Se aplican a los cuatro osciladores a la vez; el *Freq. Domain* puede además ajustarse gráfica por gráfica (ver abajo).
